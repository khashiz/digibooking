...
$has_charge = isset($order['payment_charge']) && $order['payment_charge'] != 0;
		...
		<td>
			<table width="100%"  border="0" cellspacing="1" cellpadding="2">
				<tr bgcolor="#E1E1E1" style="background-color: #E1E1E1;">
					<td width="60%"><strong><?php echo JText::_('VAPINVITEMDESC'); ?></strong></td>
					<td width="15%">&nbsp;</td>
					<td width="25%"><strong><?php echo JText::_('VAPINVITEMPRICE'); ?></strong></td>
				</tr>
				...
				foreach ($order['items'] as $item)
				{
					?>
					<tr>
						<td width="60%"><strong><?php echo $item['name']; ?></strong></td>
						<td width="15%">x<?php echo $item['quantity']; ?></td>
						<td width="25%"><?php echo VikAppointments::printPriceCurrencySymb($item['price']); ?></td>
					</tr>
					<?php
				}
				?>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2">
				...
				<?php if ($has_charge) { ?>
					<tr bgcolor="#E1E1E1">
						<td width="30%" align="left">
							<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
								<td align="left"><strong><?php echo JText::_('VAPINVPAYCHARGE', $order['payment_name']); ?></strong></td>
