...
<div class="vap-config-searchbar" style="display: none">
	...
	<div class="vap-config-searchbar-gotop">
		<a href="javascript: void(0);" onClick="animateToPageTop();"><?php echo JText::_('VAPGOTOP'); ?></a>
	</div>
</div>
...
<script>
	...
	function displaySearchBar() {
		if( searchBar.size() == 0 ) {
			jQuery('.vap-config-searchbar-stat').text('<?php echo addslashes(JText::_('VAPNOMATCHES')); ?>');
