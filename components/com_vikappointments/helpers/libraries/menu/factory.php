...
UILoader::import('libraries.menu.abstractlist');
...
abstract class MenuFactory
{
	...
	public static function getMenuType()
	{
		...
		if (is_null(static::$menuType))
		{
			 ...
			 * @since 	1.6.3
			 */
			static::$menuType = UIFactory::getEventDispatcher()->triggerOnce('onBeforeDefineVikAppointmentsMenuType');
	...
	protected static function create($alias, $parent, array $args = array())
	{
		if (!isset(static::$classMap[$alias]))
		{
			...
			if (!UILoader::import('libraries.menu.' . $type . '.' . $alias))
			{
				// menu type not found
