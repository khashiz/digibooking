 ...
 */
class VikAppointmentsViewempcustfields extends JViewUI
{
	/**
	...
	function display($tpl = null)
	{
		...
		$lim  = 10;
		$lim0 = $app->getUserStateFromRequest('empcustfields.limitstart', 'limitstart', 0, 'uint');
