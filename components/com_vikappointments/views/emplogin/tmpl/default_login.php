...
$data = array(
	 ...
	 */
	'return' => 'index.php?option=com_vikappointments&view=emplogin' . ($this->itemid ? '&Itemid=' . $this->itemid : ''),
...
// The user is already logged in but it is not assigned to any employee.
// Just display a button to allow the user to perform a logout.
else
{
	?>
	<a href="<?php echo JRoute::_('index.php?option=com_vikappointments&task=emplogin.logout&Itemid=' . $this->itemid); ?>">
