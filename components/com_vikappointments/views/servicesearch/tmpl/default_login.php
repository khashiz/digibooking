...
$query = array(
	'Itemid' => $this->itemid,
	'id_ser' => $this->idService,
	'id_emp' => $this->idEmployee,
	'date'	 => $this->lastDay,
	'month'	 => $this->month,
);
...
$data = array(
	 ...
	 *
	 * @todo 	The registration should be enabled/disabled depending 
	 * 			on a specific internal setting. Because the owner may not want
	 * 			to allow registration through com_users.
	 */
