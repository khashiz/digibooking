			...
			<div class="span6">
				<?php echo $vik->openEmptyFieldset(); ?>
					...
					<?php echo $vik->openControl(JText::_('VAPMANAGERESERVATION3').'*:'); ?>
						<input type="text" value="<?php echo JText::sprintf('FLOOR'.$this->escape($sel['ename'])); ?>" size="40" readonly />
					<?php echo $vik->closeControl(); ?>
					
					<!-- SERVICE - Text -->
					<?php echo $vik->openControl(JText::_('VAPMANAGERESERVATION4').'*:'); ?>
						<input type="text" value="<?php echo JText::sprintf($this->escape($sel['sname'])); ?>" size="40" readonly />
					<?php echo $vik->closeControl(); ?>
                ...
                <div hidden>
					...
					<?php echo $vik->openControl(JText::_('VAPMANAGERESERVATION10').':'); ?>
						<input type="number" name="duration" value="<?php echo $sel['duration']; ?>" size="40" min="0" id="vaprduration" readonly />
