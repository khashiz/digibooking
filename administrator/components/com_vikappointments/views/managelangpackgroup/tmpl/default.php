...
<form action="index.php" method="POST" name="adminForm" id="adminForm">
	...
	<div id="translation">
		<?php echo $vik->openEmptyFieldset(); ?>
			...
			<?php echo $vik->openControl(JText::_('VAPMANAGEPACKGROUP2').':'); ?>
				<input type="text" name="title" value="<?php echo (!empty($row['title']) ? $row['title'] : ''); ?>" size="40" />
	...
	<div style="display: none;" id="original">
		<?php echo $vik->openEmptyFieldset(); ?>
			...
			<?php echo $vik->openControl(JText::_('VAPMANAGEGROUP2').':'); ?>
				<input type="text" value="<?php echo (!empty($this->default['title']) ? $this->default['title'] : ''); ?>" size="40" readonly />
			<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="id_package_group" value="<?php echo $this->idPackageGroup; ?>" />
	<input type="hidden" name="tag" value="<?php echo $this->tag; ?>" />
	<input type="hidden" name="task" value="saveLangPackageGroup" />
