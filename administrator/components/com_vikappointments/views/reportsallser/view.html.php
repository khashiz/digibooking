 ...
 */
class VikAppointmentsViewreportsallser extends JViewUI
{
	/**
	...
	{	
		...
		$sel_services = $input->get('services', array(), 'array');
		...
		if (count($sel_services) > 0 && count($sel_services) < count($services))
		{
