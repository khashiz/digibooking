...
<form action="index.php" method="POST" name="adminForm" id="adminForm">
	...
	<div id="translation">
		<?php echo $vik->openEmptyFieldset(); ?>
			...
			<!-- DESCRIPTION - Editor -->
			<?php echo $vik->openControl(JText::_('VAPMANAGESERVICE3').':'); ?>
	...
	<input type="hidden" name="id_service" value="<?php echo $this->idService; ?>" />
	<input type="hidden" name="tag" value="<?php echo $this->tag; ?>" />
	<input type="hidden" name="task" value="saveLangService" />
