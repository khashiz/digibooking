...
<form action="index.php" method="POST" name="adminForm" id="adminForm">
	...
	<div id="translation">
		<?php echo $vik->openEmptyFieldset(); ?>
			...
			<!-- NOTES BEFORE PURCHASE - Editor -->
			<?php echo $vik->openControl(JText::_('VAPMANAGEPAYMENT13').':'); ?>
				<?php echo $editor->display('langprenote', (!empty($row['prenote']) ? $row['prenote'] : ''), 400, 200, 70, 20); ?>
			<?php echo $vik->closeControl(); ?>

			<!-- NOTES AFTER PURCHASE - Editor -->
			<?php echo $vik->openControl(JText::_('VAPMANAGEPAYMENT14').':'); ?>
	...
	<div style="display: none;" id="original">
		<?php echo $vik->openEmptyFieldset(); ?>
			...
			<!-- NOTES BEFORE PURCHASE - Editor -->
			<?php echo $vik->openControl(JText::_('VAPMANAGEPAYMENT13').':'); ?>
				<textarea style="width: 100%;height: 300px;min-height: 180px;resize: vertical;" readonly><?php echo (!empty($this->default['prenote']) ? $this->default['prenote'] : ''); ?></textarea>
			<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="task" value="saveLangPayment" />
