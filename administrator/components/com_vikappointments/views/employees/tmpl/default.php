	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="<?php echo $vik->getAdminTableClass(); ?>">
		...
		<?php echo $vik->openTableHead(); ?>
			<tr>
				...
				<th class="<?php echo $vik->getAdminThClass(); ?>" width="100" style="text-align: center;"><?php echo JText::_('VAPMANAGEEMPLOYEE23'); ?></th>
				<th class="<?php echo $vik->getAdminThClass(); ?>" width="100" style="text-align: center;"><?php echo JText::_('VAPMANAGEEMPLOYEE21'); ?></th>
				<th class="<?php echo $vik->getAdminThClass(); ?>" width="100" style="text-align: center;"><?php echo JText::_('VAPMANAGEEMPLOYEE29'); ?></th>
		...
		for ($i = 0, $n = count($rows); $i < $n; $i++) {
			...
			<tr class="row<?php echo ($i % 2); ?>">
				...
				<td style="text-align: left;"><a href="index.php?option=com_vikappointments&amp;task=editemployee&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $row['nickname']; ?></a></td>	
