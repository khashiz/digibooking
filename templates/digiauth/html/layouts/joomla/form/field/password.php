...
$attributes = array(
	...
	!empty($class) ? 'class="uk-input uk-input-icon uk-width-1-1 uk-text-left ltr font ' . $class . '"' : '',
	$readonly ? 'readonly' : '',
	$disabled ? 'disabled' : '',
...
/>
<span class="uk-form-icon uk-form-icon-flip"><img src="<?php echo JUri::base().'images/sprite.svg#key'; ?>" width="20" height="20" alt="" data-uk-svg></span>
</div>
<?php if ($lock): ?>
