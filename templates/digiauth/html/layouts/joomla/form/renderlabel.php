...
if (!empty($description))
{
	if ($text && $text !== $description)
	{
		...
		$classes[] = 'uk-form-label font f500 uk-display-inline-block uk-margin-small-bottom';
...
if ($required)
{
	$classes[] = 'uk-form-label font f500 uk-display-inline-block uk-margin-small-bottom required';
}

?>
<label id="<?php echo $id; ?>" for="<?php echo $for; ?>"<?php if (!empty($classes)) echo ' class="' . implode(' ', $classes) . '"'; ?><?php echo $title; ?><?php echo $position; ?>>
	<?php echo $text; ?><?php if ($required) : ?><span class="uk-text-danger">&ensp;*</span><?php endif; ?>
</label>
