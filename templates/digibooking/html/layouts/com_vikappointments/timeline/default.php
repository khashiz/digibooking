...
{
	?>
	<div class="vaptimelinewt uk-margin-remove uk-text-zero uk-width-1-1 uk-grid-small uk-grid uk-child-width-1-6" data-uk-grid>
		<?php
		foreach ($block as $k => $v)
		{
			...
			<a href="javascript: void(0);" title="<?php echo $titles_lookup[$v]; ?>" onClick="<?php echo $clickEvent; ?>" class="uk-margin-remove uk-display-block">
				<div 
					class="uk-margin-remove uk-display-block uk-padding-small fnum vap-timeline-block<?php echo ($time_format != "H:i" ? " large" : ""); ?> vaptlblock<?php echo $v; ?>"
